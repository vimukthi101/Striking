...
if(mysql_num_rows($result) == 0){
	...
	while($row = mysql_fetch_array($result)){
        ...
        <div class="col-lg-9">
        <form class="form-group" role="form" action="DeletependingProcess.php" method="post">
        ...
        <tr>
        <td>Item Type</td>
        <td><input class="form-control" type="text" name="type" value="<?php echo $type; ?>" readonly></td>
        </tr>
        <tr>
        <td>Item Name</td>
        <td><input class="form-control" type="text" name="name" value="<?php echo $name; ?>" readonly></td>
        </tr>
        <tr>
        <td>Item Price</td>
        ...
        <td><input class="form-control" type="text" name="description" value="<?php echo $des; ?>" readonly></td>
        </tr>
        <tr>
        <td>Item Added By</td>
